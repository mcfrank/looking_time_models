...
main_simulations_testing <- function(subject_n, 
                             stimuli_sequence, 
                             noise_parameter, 
  ...
  lapply(seq(1, subject_n), 
         function(x){
           main_simulation_testing(subject = x,
                              stimuli_sequence, 
...
main_simulation_testing <- function(subject = x,
                               stimuli_sequence, 
                               noise_parameter = noise_parameter, 
                               eig_from_world = 0.001,
                               max_observation = 5000, # should this be per trial or in total? currently per trial 
  ...
  ll_df_hypothetical_posterior <- lapply(seq(1, max_observation, 1), 
                            function(x){
                              list()
                                     })
