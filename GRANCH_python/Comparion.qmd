...
basic_kls = list(map(lambda e: e.item(), list(filter(lambda item: item is not None, m.all_basic_KL))))

basic_pps = list(map(lambda e: e.item(), list(filter(lambda item: item is not None, m.all_basic_PP))))
