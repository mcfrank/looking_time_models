...
# normal prior for mean is anormal distribution with mean m and sd sqrt of V^-1
...
# get posterior density of a random observation
dstudent(0.123, df,mu,sigma, log = FALSE)



```

## Step 2: Applying this to our case:
