...
```{r}
source(here("helper/faster_noisy_update_old.R"))


second_update <- faster_grid_apprxoimation_with_observation_old(
  noisy_observation = filter(os, t == 2), # i doubt this is a good idea
  last_update_posterior_df = old_posterior_after_one_udpate, 
  track_epsilon = TRUE, 
  grid_theta = thetas, 
                          grid_epsilon = epsilons, 
                          alpha_prior = alpha_prior, 
