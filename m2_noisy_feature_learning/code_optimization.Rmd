...
# lp theta given z 
```{r}
z_bar <- tibble("V1" = rep(FALSE, 1000))



no_optimization_lptheta <- function(){
  lp_theta_given_z(z_bar, theta = 0.3, epsilon = 0.99, alpha_theta = 1, beta_theta = 1, alpha_epsilon = 10, beta_epsilon = 1)
}
